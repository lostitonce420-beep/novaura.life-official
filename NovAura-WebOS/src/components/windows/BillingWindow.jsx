...
const PLANS = [
  {
    ...
    features: ['4K context window', '7 builder calls/day', '3 projects', 'Community support'],
  ...
  },
  {
    ...
    features: ['8K context window', '50 builder calls/day', '10 projects', 'Priority support', 'Custom domain'],
    limits: { context: '8K', calls: 50, projects: 10 },
    color: 'cyan',
    popular: false,
  },
  {
    ...
    features: ['16K context window', '200 builder calls/day', 'Unlimited projects', 'Priority AI queue', '3 custom domains', 'API access'],
    limits: { context: '16K', calls: 200, projects: '∞' },
    color: 'purple',
    popular: true,
  },
  {
    ...
    features: ['Up to 128K context', 'Unlimited calls', 'BYOK support', '10 custom domains', 'Advanced analytics', 'Secrets manager'],
